...
public class Area2DialogueController : MonoBehaviour
{
    ...
    [SerializeField] private string dialogueObjectName = "Dialogue (1)";
    ...
    public bool ShowDialogueAfterArea2(bool onlyOnce = true)
    {
    ...
    private void ResolveDialogueRootIfNeeded()
    {
        ...
        if (string.IsNullOrWhiteSpace(dialogueObjectName))
        {
            return;
        }
    ...
    private void OpenDialogue()
    {
        if (dialogueRoot == null)
        {
            Debug.LogWarning("[Area2DialogueController] Dialogue object was not assigned or found.");
            return;
        }
